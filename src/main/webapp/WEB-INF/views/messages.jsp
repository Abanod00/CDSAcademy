...
<jsp:include page="nav.jsp" />
	...
	<div
		...
		<img class="mr-3" alt="" width="48" height="48"
			src='<c:url value="/resources/img/hpe-cds-logo.png"  ></c:url>'>
		<div class="lh-100">
	...
	<div class="my-3 p-3 bg-white rounded box-shadow">
			...
			<div class="media text-muted pt-3">
				...
				<div
					...
					<div
						...
						<strong class="text-gray-dark">${randomPersons.name}</strong> <a
							href="#">Follow</a>
					</div>
		...
		<small class="d-block text-right mt-3"> <a
			href="${contextPath}/people/${personLogin.id}">All suggestions</a>
		</small>
	</div>
	</main>

	<div class="container">
		<h3 id="form_header" class="text-warning" align="center">Post
			message</h3>
		<div></div>
		...
		<form id="user_form" action="${addMessage}" method="POST">
			<div class="form-group">
				<input type="hidden" class="form-control" id="idPerson"
					value="${personLogin.id}" name="idPerson" readonly>
			</div>
			<div class="form-group">
				<input type="hidden" class="form-control" id="aliasPerson"
					value="${personLogin.alias}" name="aliasPerson" readonly>
			</div>
			<div class="form-group">
				<textarea class="form-control" name='message' id='message'></textarea>
			</div>
			<button id="postMessage" type="submit" class="btn btn-primary">Post
				Message</button>
		</form>
	</div>
